...
var seo = function (pluginConfig) { return function (config) {
    var _a, _b;
    var seoFields = [
        {
            name: 'meta',
                ...
                if (pluginConfig === null || pluginConfig === void 0 ? void 0 : pluginConfig.tabbedUI) {
                    var seoFieldsAsTabs = [{
                            ...
                            tabs: __spreadArray(__spreadArray([], ((_b = collection === null || collection === void 0 ? void 0 : collection.fields) === null || _b === void 0 ? void 0 : _b[0].type) === 'tabs'
                                ? (_d = (_c = collection === null || collection === void 0 ? void 0 : collection.fields) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.tabs : [{
                                    label: ((_e = collection === null || collection === void 0 ? void 0 : collection.labels) === null || _e === void 0 ? void 0 : _e.singular) || 'Content',
                    ...
                    return (__assign(__assign({}, collection), { fields: seoFieldsAsTabs }));
                }
                ...
                if (pluginConfig === null || pluginConfig === void 0 ? void 0 : pluginConfig.tabbedUI) {
                    var seoFieldsAsTabs = [{
                            ...
                            tabs: __spreadArray(__spreadArray([], ((_b = global === null || global === void 0 ? void 0 : global.fields) === null || _b === void 0 ? void 0 : _b[0].type) === 'tabs'
                                ? (_d = (_c = global === null || global === void 0 ? void 0 : global.fields) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.tabs : [{
                    ...
                    return (__assign(__assign({}, global), { fields: seoFieldsAsTabs }));
                }
