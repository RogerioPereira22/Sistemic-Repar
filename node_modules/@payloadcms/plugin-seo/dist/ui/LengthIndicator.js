...
var LengthIndicator = function (props) {
    ...
    return (react_1.default.createElement("div", { style: {
        ...
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("small", null, "".concat((text === null || text === void 0 ? void 0 : text.length) || 0, "/").concat(minLength, "-").concat(maxLength, " chars, "),
                (textLength === 0 || charsUntilMin > 0) && (react_1.default.createElement(react_1.Fragment, null, "".concat(charsUntilMin, " to go"))),
                charsUntilMin <= 0 && charsUntilMax >= 0 && (react_1.default.createElement(react_1.Fragment, null, "".concat(charsUntilMax, " left over"))),
                charsUntilMax < 0 && (react_1.default.createElement(react_1.Fragment, null, "".concat(charsUntilMax * -1, " too many"))))),
        react_1.default.createElement("div", { style: {
                height: '2px',
                width: '100%',
