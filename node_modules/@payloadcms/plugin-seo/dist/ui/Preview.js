...
var Preview = function (props) {
    var generateURL = (props || {}).pluginConfig.generateURL; // TODO: this typing is temporary until payload types are updated for custom field props;
    var fields = (0, forms_1.useWatchForm)().fields;
    var _a = fields["meta.title"], _b = _a === void 0 ? {} : _a, metaTitle = _b.value, _c = fields["meta.description"], _d = _c === void 0 ? {} : _c, metaDescription = _d.value;
    var _e = (0, react_1.useState)(), href = _e[0], setHref = _e[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, generateURL({ doc: { fields: fields } })];
                    case 1:
                        newHref = _a.sent();
                        setHref(newHref);
                        _a.label = 2;
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("div", null, "Preview"),
