...
export declare class BasePayload<TGeneratedTypes extends GeneratedTypes> {
     ...
     */
    update: <T extends keyof TGeneratedTypes["collections"]>(options: UpdateOptions<T>) => Promise<TGeneratedTypes["collections"][T]>;
    delete: <T extends keyof TGeneratedTypes["collections"]>(options: DeleteOptions<T>) => Promise<TGeneratedTypes["collections"][T]>;
    /**
