...
const ColumnSelector = (props) => {
    ...
    const [fields, setFields] = (0, react_1.useState)(() => (0, flattenTopLevelFields_1.default)(collection.fields, true));
    (0, react_1.useEffect)(() => {
        setFields((0, flattenTopLevelFields_1.default)(collection.fields, true));
    }, [collection.fields]);
    const { i18n } = (0, react_i18next_1.useTranslation)();
    const uuid = (0, react_1.useId)();
    const editDepth = (0, EditDepth_1.useEditDepth)();
    return (react_1.default.createElement("div", { className: baseClass }, fields && fields.map((field, i) => {
        const isEnabled = columns.find((column) => column === field.name);
        return (react_1.default.createElement(Pill_1.default, { onClick: () => {
                ...
                setColumns(newState);
            }, alignIcon: "left", key: `${collection.slug}-${field.name || i}${editDepth ? `-${editDepth}-` : ''}${uuid}`, icon: isEnabled ? react_1.default.createElement(X_1.default, null) : react_1.default.createElement(Plus_1.default, null), className: [
                `${baseClass}__column`,
                isEnabled && `${baseClass}__column--active`,
            ].filter(Boolean).join(' ') }, (0, getTranslation_1.getTranslation)(field.label || field.name, i18n)));
    })));
};
