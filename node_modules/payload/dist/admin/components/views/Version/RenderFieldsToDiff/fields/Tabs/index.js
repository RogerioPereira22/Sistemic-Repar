...
const Tabs = ({ version, comparison, permissions, field, locales, fieldComponents, }) => (react_1.default.createElement("div", { className: baseClass },
    react_1.default.createElement("div", { className: `${baseClass}__wrap` }, field.tabs.map((tab, i) => {
        if ('name' in tab) {
            return (react_1.default.createElement(Nested_1.default, { key: i, version: version[tab.name], comparison: comparison[tab.name], permissions: permissions, field: tab, locales: locales, fieldComponents: fieldComponents }));
        }
