...
const RelationshipCell = (props) => {
    ...
    return (react_1.default.createElement("div", { className: baseClass, ref: intersectionRef },
        values.map(({ relationTo, value }, i) => {
            ...
            const label = (document === null || document === void 0 ? void 0 : document[relatedCollection.admin.useAsTitle]) ? document[relatedCollection.admin.useAsTitle] : `${t('untitled')} - ID: ${value}`;
