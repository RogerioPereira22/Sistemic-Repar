...
const BlocksField = (props) => {
    ...
    const { label, name, path: pathFromProps, blocks, labels: labelsFromProps, fieldTypes, maxRows, minRows, required, validate = validations_1.blocks, permissions, indexPath, admin: { readOnly, description, condition, initCollapsed, className, }, } = props;
    ...
    return (react_1.default.createElement(react_beautiful_dnd_1.DragDropContext, { onDragEnd: onDragEnd },
        react_1.default.createElement("div", { id: `field-${path.replace(/\./gi, '__')}`, className: classes },
            ...
            react_1.default.createElement(NullifyField_1.NullifyLocaleField, { path: path, fieldValue: value }),
