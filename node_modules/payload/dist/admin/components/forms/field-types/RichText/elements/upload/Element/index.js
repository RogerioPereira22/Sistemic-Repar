            ...
            react_1.default.createElement("div", { className: `${baseClass}__topRow` },
                ...
                react_1.default.createElement("div", { className: `${baseClass}__topRowRightPanel` },
                    ...
                    react_1.default.createElement("div", { className: `${baseClass}__actions` },
                        (value === null || value === void 0 ? void 0 : value.id) && (react_1.default.createElement(DocumentDrawerToggler, { className: `${baseClass}__doc-drawer-toggler` },
                        ...
                        react_1.default.createElement(ListDrawerToggler, { className: `${baseClass}__list-drawer-toggler`, disabled: (_a = fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.admin) === null || _a === void 0 ? void 0 : _a.readOnly },
                            react_1.default.createElement(Button_1.default, { icon: "swap", round: true, buttonStyle: "icon-label", onClick: () => {
                                    // do nothing
                                }, el: "div", tooltip: t('swapUpload'), disabled: (_b = fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.admin) === null || _b === void 0 ? void 0 : _b.readOnly })),
                        react_1.default.createElement(Button_1.default, { icon: "x", round: true, buttonStyle: "icon-label", className: `${baseClass}__removeButton`, onClick: (e) => {
                                e.preventDefault();
                                removeUpload();
                            }, tooltip: t('removeUpload'), disabled: (_c = fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.admin) === null || _c === void 0 ? void 0 : _c.readOnly })))),
